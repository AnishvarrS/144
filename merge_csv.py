...
with open('E:\\Whitehatjunior\\Module3\\movie_recommendation_142\\movie_recommendation_142_fixed_errors-main\\c-142-main\\c-142-main\\movies.csv') as f:
    reader = csv.reader(f)
    data = list(reader)
    all_movies = data[1:]
    headers = data[0]
...
with open("E:\\Whitehatjunior\\Module3\\movie_recommendation_142\\movie_recommendation_142_fixed_errors-main\\c-142-main\\c-142-main\\final.csv", "a+") as f:
